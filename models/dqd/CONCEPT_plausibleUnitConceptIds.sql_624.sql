...
WITH cte_all  AS (SELECT cte.num_violated_rows
 ...
 ,'The number and percent of records for a given CONCEPT_ID 3007527 (WEIGHT OF STONE) with implausible units (i.e., UNIT_CONCEPT_ID NOT IN (8504,8564,8576,8739,9275,9294,9295,9319,9343,9345,9347,9354,9356,9357,9372,9373,9374,9392,9400,9402,9409,9410,9425,9479,9485,9496,9529,9600,9647,9648,9655)).' as check_description
 ,'MEASUREMENT' as cdm_table_name
 ,'MEASUREMENT_CONCEPT_ID' as cdm_field_name
 ,' 3007527' as concept_id
 ...
 ,'' as warning
 ,'' as error
 ,'concept_plausibleunitconceptids_measurement_measurement_concept_id_3007527' as checkid
 ,0 as is_error
 ,0 as not_applicable
...
FROM (
 ...
 WHERE m.MEASUREMENT_CONCEPT_ID = 3007527
 AND
