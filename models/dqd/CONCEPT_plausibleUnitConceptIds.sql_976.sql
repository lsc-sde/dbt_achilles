...
WITH cte_all  AS (SELECT cte.num_violated_rows
 ...
 ,'' as warning
 ,'' as error
 ,'concept_plausibleunitconceptids_measurement_measurement_concept_id_3043744' as checkid
 ,0 as is_error
 ,0 as not_applicable
...
FROM (
 ...
 WHERE m.MEASUREMENT_CONCEPT_ID = 3043744
 AND
