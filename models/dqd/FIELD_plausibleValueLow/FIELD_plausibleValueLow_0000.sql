...
FROM (
 ...
 WHERE CAST(cdmTable.CDM_RELEASE_DATE AS DATE) < to_date('20000101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.CDM_SOURCE cdmTable
 WHERE CAST(cdmTable.SOURCE_RELEASE_DATE AS DATE) < to_date('20000101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.COHORT_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc_achilles.COHORT cdmTable
 WHERE CAST(cdmTable.COHORT_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.CONDITION_ERA_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.CONDITION_ERA cdmTable
 WHERE CAST(cdmTable.CONDITION_ERA_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.CONDITION_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.CONDITION_OCCURRENCE cdmTable
 WHERE CAST(cdmTable.CONDITION_END_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.CONDITION_OCCURRENCE cdmTable
 WHERE CAST(cdmTable.CONDITION_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.CONDITION_OCCURRENCE cdmTable
 WHERE CAST(cdmTable.CONDITION_START_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.DEATH_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DEATH cdmTable
 WHERE CAST(cdmTable.DEATH_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.DEVICE_EXPOSURE_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DEVICE_EXPOSURE cdmTable
 WHERE CAST(cdmTable.DEVICE_EXPOSURE_END_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DEVICE_EXPOSURE cdmTable
 WHERE CAST(cdmTable.DEVICE_EXPOSURE_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DEVICE_EXPOSURE cdmTable
 WHERE CAST(cdmTable.DEVICE_EXPOSURE_START_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.DOSE_ERA_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DOSE_ERA cdmTable
 WHERE CAST(cdmTable.DOSE_ERA_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.DRUG_ERA_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DRUG_ERA cdmTable
 WHERE CAST(cdmTable.DRUG_ERA_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DRUG_EXPOSURE cdmTable
 WHERE CAST(cdmTable.DRUG_EXPOSURE_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DRUG_EXPOSURE cdmTable
 WHERE CAST(cdmTable.DRUG_EXPOSURE_END_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DRUG_EXPOSURE cdmTable
 WHERE CAST(cdmTable.DRUG_EXPOSURE_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DRUG_EXPOSURE cdmTable
 WHERE CAST(cdmTable.DRUG_EXPOSURE_START_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.DRUG_EXPOSURE cdmTable
 WHERE CAST(cdmTable.VERBATIM_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.EPISODE_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.EPISODE cdmTable
 WHERE CAST(cdmTable.EPISODE_END_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.EPISODE cdmTable
 WHERE CAST(cdmTable.EPISODE_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.EPISODE cdmTable
 WHERE CAST(cdmTable.EPISODE_START_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.MEASUREMENT_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.MEASUREMENT cdmTable
 WHERE CAST(cdmTable.MEASUREMENT_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.NOTE_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.NOTE cdmTable
 WHERE CAST(cdmTable.NOTE_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.NLP_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.OBSERVATION_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.OBSERVATION cdmTable
 WHERE CAST(cdmTable.OBSERVATION_DATETIME AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.OBSERVATION_PERIOD_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.OBSERVATION_PERIOD cdmTable
 WHERE CAST(cdmTable.OBSERVATION_PERIOD_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.PAYER_PLAN_PERIOD_END_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 cdmTable.*
 FROM hive_metastore.dev_vc.PAYER_PLAN_PERIOD cdmTable
 WHERE CAST(cdmTable.PAYER_PLAN_PERIOD_START_DATE AS DATE) < to_date('19500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
...
FROM (
 ...
 WHERE CAST(cdmTable.BIRTH_DATETIME AS DATE) < to_date('18500101', 'yyyymmdd')
 /*violatedRowsEnd*/
 ) violated_rows
) violated_row_count cross join (SELECT
 COUNT(*) AS num_rows
